...
export class ColumnServiceService {
  ...
  private StaticAllColumns:any[]=[
    ...
    {
      header: 'Quantity', datafield: 'Quantity', width: 140,
      ...
      let result;
        if (value >= 0) {
         result ='<div class="jqx-grid-cell-right-align" style="color:green;">' +  value.toString()+'</div>';
  ...
  },
  {
    ...
    cellclassname: function (row: any, column: any, value: any, data: any)
     { if (value == "▲") { return 'greenColor'; } else if (value == "▼") { return 'redColor'; } else { return 'alignCenter'; } },
  ...
  getActiveInactiveColumns()
  {
   ...
   // return localStorage.setItem('allColumns',JSON.stringify(this.allColumns));
